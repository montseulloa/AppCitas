...
public class UsersControllerTests
{
    ...
    [Theory]
    [InlineData("OK", "lisa", "Pa$$word", 5, 1)]
    ...
    [Theory]
    [InlineData("NoContent", "lisa", "Pa$$word", "introduction", "lookingFor", "interests", "city", "country")]
    ...
    [Theory]
    [InlineData("Created", "lisa", "Pa$$word", "../../../harry.jpg")]
    ...
    [Theory]
    [InlineData("NoContent", "lisa", "Pa$$word", "../../../xd.jpg")]
    public async Task SetMainPhoto_ShouldOK(string statusCode, string username, string password, string file)
    {
        ...
        requestUri = $"{apiRoute}" + "/set-main_photo/" + id;
    ...
    [Theory]
    [InlineData("OK", "lisa", "Pa$$word", "../../../cat.jpg")]
    ...
    [Theory]
    [InlineData("NotFound", "lisa", "Pa$$word", "20")]
    public async Task DeletePhoto_ShouldNotFound(string statusCode, string username, string password, string id)
    {
        // Arrange
        _client.DefaultRequestHeaders.Authorization = null;
        var user = await LoginHelper.LoginUser(username, password);
